...
import {ConnectionType,BoundaryType, BoundaryColor,TrafficDeviceType,LaneType, LaneLineType, LaneLineColor, LaneEntryExitType} from '@mapperai/mapper-annotated-scene'
