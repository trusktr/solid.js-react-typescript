...
import AnnotatedSceneState from '@mapperai/mapper-annotated-scene/src/store/state/AnnotatedSceneState'
...
import {getAnnotatedSceneStore} from '@mapperai/mapper-annotated-scene/src/store/AppStore'
