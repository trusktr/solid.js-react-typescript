...
import {getRoadSegments, getVertices} from "annotator-operation-hydra/src/services/RoadNetworkService"
...
export default class RoadNetworkEditorActions extends ActionFactory<RoadNetworkEditorState, ActionMessage<RoadNetworkEditorState>> {
  ...
  removeUnpublishedSegments(segmentsToRemove:Map<string, LineSegment>) {
    ...
    return (roadEditorState: RoadNetworkEditorState) => {
      ...
      return new RoadNetworkEditorState({...roadEditorState, unpublishedLineSegments: existingUnpublishedSegments})
    }
  }
  ...
  setLineSegments(lineSegments:Map<string, LineSegment>) {
    ...
    return (roadEditorState:RoadNetworkEditorState) => new RoadNetworkEditorState({...roadEditorState, lineSegments: lineSegments})
  }
  ...
  setVertices(vertices:Map<string, RoadnetworkVertex>) {
    ...
    return (roadEditorState:RoadNetworkEditorState) => new RoadNetworkEditorState({...roadEditorState, vertices: vertices})
  }
  ...
  resetMapSelections() {
    ...
    return (roadEditorState: RoadNetworkEditorState) => new RoadNetworkEditorState({...roadEditorState,
      selectedLineSegment: null,
      selectedVertex: null,
      startingPoint: null,
      previousPoint: null,
