...
export default class AnnotatedSceneController extends React.Component<IAnnotatedSceneControllerProps, IAnnotatedSceneControllerState> {
	...
	constructor(props) {
		...
		if (this.settings.enableAnnotationTileManager) {
			this.annotationTileManager = new AnnotationTileManager(
				...
				// TODO JOE (@Ryan) AnnotationManager is passed into
  ...
  activateReadOnlyViewingMode() {
	...
	render() {
		...
		return (
		  <React.Fragment>
	        <StatusWindow ref={this.getStatusWindowRef} {...{utmCoordinateSystem}}/>
	        <PointCloudManager ref={this.getPointCloudManagerRef} sceneManager={} pointCloudTileManager={} layerManager={} handleTileManagerLoadError={} getCurrentPointOfInterest={this.currentPointOfInterest}/>
	        <SceneManager ref={this.getSceneManagerRef} width={1000} height={1000}/>
	        <LayerManager ref={this.getLayerManagerRef} onRerender={}/>
