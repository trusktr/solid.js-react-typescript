...
export abstract class Annotation {
	...
	constructor(inputInterface?: AnnotationJsonInputInterface, readonly channel?: EventEmitter) {
	...
	updateVisualization(): void {
		this.channel && this.channel.emit(Events.ANNOTATION_VISUAL_UPDATE, this)
	}
