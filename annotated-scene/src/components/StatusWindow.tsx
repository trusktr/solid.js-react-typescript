...
// TODO JOE PACKAGE remove this, it belongs in Kiosk, not in StatusWindow
// import {
// 	LocationServerStatusClient,
// 	LocationServerStatusLevel,
// } from '../../../../src/kiosk/clients/LocationServerStatusClient'
const {
	LocationServerStatusClient,
	LocationServerStatusLevel,
} = require(`${__base}/src/kiosk/clients/LocationServerStatusClient`)
